...
int main(int argc, char *argv[])
{
    ...
    LOG(INFO) << fmt::format(
        "[ INPUT] {}x{}, format: {}, fps: {}/{}, tbr: {}/{}, tbc: {}/{}, tbn: {}/{}", decoder_ctx->width,
        decoder_ctx->height, av_get_pix_fmt_name(decoder_ctx->pix_fmt),
    ...
    LOG(INFO) << fmt::format(
        "[OUTPUT] {}x{}, format: {}, framerate: {}/{}, tbc: {}/{}, tbn: {}/{}", encoder_ctx->width,
        encoder_ctx->height, av_get_pix_fmt_name(encoder_ctx->pix_fmt), encoder_ctx->framerate.num,
    ...
    while (av_read_frame(decoder_fmt_ctx, in_packet) >= 0) {
        ...
        while (ret >= 0) {
            ...
            while (ret >= 0) {
                ...
                LOG(INFO) << fmt::format("[ENCODING] frame = {:>3d}, pts = {:>7d}, dts = {:>7d}",
